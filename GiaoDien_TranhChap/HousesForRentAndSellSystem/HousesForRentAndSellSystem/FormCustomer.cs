...
namespace HousesForRentAndSellSystem
{
    public partial class FormCustomer : Form
    {
        ...
        private void btnHome_Click(object sender, EventArgs e)
        {
            ...
            cn.Open();
            var cmd = new SqlCommand("SEE_ALL_CONTRACT", cn);
        ...
        private void btnXemGiaNB_Click(object sender, EventArgs e)
        {
            ...
            cn.Open();
            var cmd = new SqlCommand("CHECK_PRICE", cn);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            cn.Open();
            var cmd = new SqlCommand("FIND_HOUSE_BY_STREET", cn);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        private void btnXemDSNhaBan_Click(object sender, EventArgs e)
        {
            ...
            cn.Open();
            var cmd = new SqlCommand("SEE_HOUSE_FOR_SELL", cn);
            cmd.CommandType = CommandType.StoredProcedure;
            var dap = new SqlDataAdapter(cmd);
            cmd.ExecuteNonQuery();
            cn.Close();
        ...
        private void btnCapNhatYC_Click_1(object sender, EventArgs e)
        {
            movePanelSide(btnCapNhatYC);
            cn.Open();
            var cmd = new SqlCommand("SEE_CONTRACT", cn);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            cn.Open();
            var cmd = new SqlCommand("FIND_HOUSE_WITH_PRICE", cn);
            cmd.CommandType = CommandType.StoredProcedure;
